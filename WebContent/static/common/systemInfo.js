$(function() {
	...
	var main_one = echarts.init(document.getElementById('main_one'),'macarons');
	var main_two = echarts.init(document.getElementById('main_two'),'macarons');
	var main_three = echarts.init(document.getElementById('main_three'),'macarons');
	one_option = {
		    tooltip : {
		        formatter: "{a} <br/>{b} : {c}%"
		    },
