			...
			function() {
				...
				validateForm = $("#inputForm")
						.validate(
								{
									rules: {
										name: {remote: "${ctx}/ident/application/checkName?oldname=" + encodeURIComponent("${application.name}")}
									},
									messages: {
										name: {remote: "应用名称已存在"}
									},
...
<body class="hideScroll">
	<form:form id="inputForm" modelAttribute="application"
		action="${ctx}/ident/application/save" enctype="multipart/form-data"
			...
			<tbody>
				...
				<tr>
					...
					<td class="width-35 appl_radio">
						<form:radiobutton path="accessWay" value="1" checked="true" class="required" /><span>&nbsp;单点登录&nbsp;</span>
						<form:radiobutton path="accessWay" value="2" class="required" /><span>&nbsp;超链接&nbsp;</span>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font
