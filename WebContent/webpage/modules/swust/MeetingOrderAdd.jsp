...
<body>
	<%@include file="/webpage/include/swustMobileHeader.jsp"%>
	<!--查看信息模态框-->
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title text-center" id="meetingReason">预约事由</h3>
				</div>
	...
	<div class="container-fluid change-padding">
		<p class="my-booking">${requestScope.sysOrderList.orderReason } 车辆预约</p>
	</div>
