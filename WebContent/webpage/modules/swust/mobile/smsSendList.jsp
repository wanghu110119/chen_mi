	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title text-center">续费短信提醒服务</h3>
			</div>
					...
					<form class="form-horizontal" id="charge-Form" novalidate="novalidate">
						...
						<div class="col-xs-12 col-sm-6">
							<div class="form-group">
								<label for="recharge-CarId" class="col-sm-5 control-label" style="text-align:center"><span style="color:red">* </span>车牌号码:</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label for="recharge-Phone" class="col-sm-5 control-label">电话号码:</label>
								<div class="col-sm-7">
									<input type="text" class="form-control " readonly="readonly" name="recharge-Phone" id="recharge-Phone">
								</div>
							</div>
							<div class="form-group">
								<label for="recharge-Time" class="col-sm-5 control-label">续约时限(月):</label>
								<div class="col-sm-7">
						...
						<div class="col-xs-12 col-sm-6">
							<div class="form-group">
								<label for="recharge-Owner" class="col-sm-5 control-label"><span style="color:red">* </span>车主姓名:</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label for="surplus-Time" class="col-sm-5 control-label">剩余时限(天):</label>
								<div class="col-sm-7">
									<input type="text" class="form-control " readonly="readonly" name="surplus-Time" id="surplus-Time">
								</div>
							</div>
							<div class="form-group">
								<label for="recharge-Money" class="col-sm-5 control-label">续约费用:</label> 
								<div class="col-sm-7">
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title text-center" id="textChange-change">新增短信提醒服务</h3>
			</div>
			<div class="modal-body">
				<div class="row">
					<form class="form-horizontal" id="formsubmit-change" action="" novalidate="novalidate">
						<div class="col-xs-12 col-sm-6">
							<div class="form-group">
								<label for="smsCarId-change" class="col-sm-5 control-label"><span style="color:red">* </span>车牌号码:</label>
								<div class="col-sm-7">
									<input type="text" class="form-control required valid" onchange="" name="name" id="smsCarId-change" aria-required="true">
								</div>
							</div>
							<div class="form-group">
								<label for="smsCarType-change" class="col-sm-5 control-label">车辆类型:</label>
								<div class="col-sm-7">
...
<!-- 									<input type="text" class="form-control " name="carType" id="carType"> -->
							...
							<div class="form-group">
								<label for="smsServiceTime-change" class="col-sm-5 control-label">服务时限(天):</label>
								<div class="col-sm-7">
									<input  class="form-control " name="serviceTime-change" id="smsServiceTime-change" placeholder="请输入月份基数">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6">
							<div class="form-group">
								<label for="smsOwner-change" class="col-sm-5 control-label"><span style="color:red">* </span>车主姓名:</label>
								<div class="col-sm-7">
							...
							<div class="form-group">
								<label for="smsPhone-change" class="col-sm-5 control-label">联系电话:</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" name="phone-change" id="smsPhone-change">
								</div>
							</div>
							<div class="form-group">
								<label for="money-change" class="col-sm-5 control-label">服务费用:</label>
								<div class="col-sm-7">
...
function batchDeleteSms(){
	...
	$.ajax({
		type : "POST",
		url : "mobile/swust/car/batchDelete",
		traditional: true,
		data : {
			ids : selectIds,
		},
	...
	validateChangeForm = $("#formsubmit-change").validate({
		rules:{
			name:{
				...
				remote:{                                          
		               type:"POST",//验证单位是否存在
		               url:"mobile/swust/car/checkCarId",
		               data:{
		                 carId:function(){return $("#smsCarId-change").val();},
		                 id:function(){return $("#oid-change").val();}
		               } 
		            }
			},
			owner:{
  ...
  return false;
	...
	if($("#recharge-Time").val()===""||$("#recharge-Time").val()==null){
		...
		$('#continue').modal('hide');
		  $.ajax({
				type : "POST",
				url : "mobile/swust/car/rechargeTime",
				data : {
					id:$("#inputSubmit").val(),
