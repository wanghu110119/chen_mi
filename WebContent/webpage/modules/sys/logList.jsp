...
<div class="ibox-title">
	...
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post"  class="form-inline">
		...
		<div class="form-group">
			...
			<span>用户：</span>
				<input id="createBy.loginName" name="createBy.loginName" type="text" maxlength="50" class="form-control input-sm" value="${log.createBy.loginName}"/>
			<span>URI：</span>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead><tr>	<th> <input type="checkbox" class="i-checks"></th><th>操作菜单</th><th>操作用户</th><th>归属学校</th><th>组织机构</th><th>URI</th><th>提交方式</th><th>操作者IP</th><th>操作时间</th></thead>
