		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         ...
		         <td  class="width-35" ><form:input path="name" htmlEscape="false" maxlength="50" class="required form-control specialChar"/></td>
		      </tr>
		      <tr>
		      ...
		      <tr>
		         ...
		         <td  class="width-15 active"><label class="pull-right">项目应用:</label></td>
		         <td  class="width-35" >
		         	<form:select path="sysProject.id" class="form-control">
        				<form:options items="${splist}" itemLabel="name" itemValue="id" htmlEscape="false"/>
        			</form:select>  
        		 </td>
		      </tr>
		    </tbody>
