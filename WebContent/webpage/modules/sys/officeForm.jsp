		   ...
		   <tbody>
		      <tr>
		       ...
		       <tr>
		         ...
		         <td class="width-35"><form:input path="name" htmlEscape="false" maxlength="50" class="form-control specialChar required"/></td>
		         <td  class="width-15"  class="active"><label class="pull-right">机构编码:</label></td>
		         <td class="width-35"><form:input path="code" htmlEscape="false" maxlength="50" class="form-control specialChar"/></td>
		      </tr>
		       <tr>
		      ...
		      <tr>
		        ...
		        <td class="width-35">
		             <input id="postIds" name="postIds" class="form-control" type="hidden" value="${office.postIds}">
    <div class="input-group">
        <input id="postNames" name="postNames" readonly="readonly" type="text" value="${office.postNames}" class="form-control valid" style=""  aria-invalid="false">
...
<script type="text/javascript">
    $("#postButton, #postNames").click(function(){
        ...
        top.layer.open({
            ...
            content: "${ctx}/sys/office/postTree?id="+$("#id").val() ,
            btn: ['确定', '关闭']
        ...
        cancel: function(index){ //或者使用btn2
		      ...
		      <tr>
		         ...
		         <td class="width-35"><form:input path="zipCode" htmlEscape="false" maxlength="50" cssClass="form-control specialChar" /></td>
		         <td  class="width-15" class="active"><label class="pull-right">负责人:</label></td>
		         <td class="width-35"><form:input path="master" htmlEscape="false" maxlength="50" cssClass="form-control specialChar" /></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="pull-right">电话:</label></td>
		         <td class="width-35"><form:input path="phone" htmlEscape="false" maxlength="50" cssClass="form-control isMobile" /></td>
		         <td  class="width-15"  class="active"><label class="pull-right">传真:</label></td>
		         <td class="width-35"><form:input path="fax" htmlEscape="false" maxlength="50" cssClass="form-control specialChar" /></td>
		      </tr>
		      <tr>
		         <td class="width-15 active"><label class="pull-right ">邮箱:</label></td>
		         <td class="width-35"><form:input path="email" htmlEscape="false" maxlength="50" cssClass="form-control email" /></td>
