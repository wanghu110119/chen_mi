			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
						<small>
							<img class="img-circle" style="width: 25px;height: 25px;" src="${ctx}/ident/application/download?pic=${ulogo}">
							${uname }
						</small>
					</a>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-100">
							<span class="blue bolder">${dns}</span>
							 &copy; 2015-2020
							<span class="blue bolder">${cname}</span>
						</span>
