...
<head>
	...
	<%@ include file="/webpage/include/head-test.jsp"%>
    <meta name="keywords" content="mht快速开发平台">
    <meta name="description" content="mht，采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的快速开发平台">
	<style type="text/css">
		.nav li i{width: 12px;}
	</style>
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" style="height:64px;width:64px;" src="${fns:getUserImage(ctxStatic)}" /></span>
                        ...
                        <div class="logo-element">Datacos
                        </div>
                    </li>
...
<!--                             </div> -->
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                    	<li class="dropdown">
                    		<a href="${ctx}/backHomePage" class="roll-nav roll-left J_tabExit lang-select"><i class="fa fa fa-sign-out"></i> 返回门户</a>
                    	</li>
                        <li class="dropdown">
            ...
            <div class="footer">
                <div class="pull-left"><a href="${dns}">${dns}</a> &copy; 2015-2025&nbsp;${cname}</div>
            </div>
        </div>
        <!--右侧部分结束-->
...
<%@ include file="/webpage/include/bottom.jsp"%>
