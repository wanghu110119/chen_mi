...
<html>
	...
	<head>
		...
		<!-- mht -->
		<link href="${ctxStatic}/common/mht.css" type="text/css" rel="stylesheet" />
		<script src="${ctxStatic}/common/mht.js" type="text/javascript"></script>
...
<%-- 									<img src="${ctxStatic }/common/login/images/logo.png" style="width:280px"> --%>
									<img src="${ctx}/ident/application/download?pic=${ulogo}" style="width:280px;height: 100px;">
									<br>
								</h1>
							...
							<div class="center"><h4 id="id-company-text"><font color="#A90E0E">&copy; ${dns}</font></h4></div>
