...
<body>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/modifyPwd"  method="post" class="form-horizontal form-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="oldPassword" name="oldPassword" type="password" value="" maxlength="50" minlength="${pwsmin }"
		         class="form-control required ${complex ? 'specialChar beginChar pwsChar':''}" rangelength="[${pwsmin },20]"  class="form-control  max-width-250 required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="confirmNewPassword" name="confirmNewPassword" type="password" value="" maxlength="50" minlength="${pwsmin }"
		         class="form-control required ${complex ? 'specialChar beginChar pwsChar':''}" rangelength="[${pwsmin },20]" class="form-control  max-width-250 required" equalTo="#newPassword"></input>
			</div>
		</div>
