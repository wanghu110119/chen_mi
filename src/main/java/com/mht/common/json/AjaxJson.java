...
public class AjaxJson {
	...
	private String code = String.valueOf(ApiCodeEnum.SUCCESS.getCode());// 操作成功
	private String msg = ApiCodeEnum.SUCCESS.getMsg();// 提示信息
	private String sub_code = ApiCodeEnum.SUCCESS.getSub_code();// （明细返回码）
	private String sub_msg = ApiCodeEnum.SUCCESS.getSub_msg();// （明细返回码描述）
