...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 */
	public static String getYearBack() {
		return DateFormatUtils.format(new Date(), "yy", Locale.CHINESE);
	}
	 ...
	 * @author com.mhout.xyb
	 */
	public static double getTwoDateForHour(Date before, Date after) {
		long beforeTime = before.getTime();
		long afterTime = after.getTime();
		return Math.ceil((afterTime - beforeTime) / (1000 * 60 * 60));
	}
