...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @return
	 */
	public static boolean isRightType(String fileName, String[] types) {
	 ...
	 * 解压文件 
	 * @param file  //被解压的文件
	 * @param destDir //解压存放路径
	 * @throws Exception
	 */
	public static void decomFile(File file, String destDir) throws Exception {
		String fileName = file.getPath();
		decomFile(fileName, destDir);
	}

	/**
	 * 解压文件
	 * @param fileName 被解压的文件路径
	 * @param destDir //解压存放路径
	 * @return
	 * @throws Exception
	 */
	public static String decomFile(String fileName, String destDir) throws Exception {
		if (fileName.endsWith("zip")) {
			unZipFiles(fileName, destDir);
		} else {
			unRarFiles(fileName, destDir);
		}
		return destDir;
	}
	 ...
	 * @throws Exception
	 */
	public static void unRarFiles(String rarFilename, String destDir) throws Exception {
		File dstDiretory = new File(destDir);// 创建指定解压后存放的目录对象
			...
			if (a != null) {
				...
				while (fh != null) {
					...
					if (fh.isDirectory()) {// 表示是文件夹
						...
						String tmpUrl = destDir + File.separator + dirName;
						...
						String tmpUrl = destDir + File.separator + dirName.trim();
