...
//			}
	...
	/**
	 * @Title: beanValidatorForBinding 
	 * @Description: @Valid 校验
	 * @param result
	 * @author com.mhout.xyb
	 */
	public boolean beanValidatorForBinding(BindingResult result, AjaxJson ajaxJson) {
		if (result.hasErrors()) {
			List<ObjectError> errors = result.getAllErrors();
			for (ObjectError objectError : errors) {
				ajaxJson.setMsg(objectError.getDefaultMessage());
			}
			return false;
		}
		return true;
