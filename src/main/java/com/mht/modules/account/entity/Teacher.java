...
public class Teacher extends DataEntity<Teacher> {
    ...
    public static final String ROLE_TEACHER_NAME = "教工";
    ...
    private String education;// 学历层次 专科、本科、研究生、博士 字典
    private String duty;// 职务类型 教育、管理 字典
    private String otherDuty;// 其他职务 教务处专员 字典
    private String outside;// 是否校外教工，默认 非 字典
    ...
    public Teacher(String id, String loginName) {
        super(id);
    ...
    @ExcelField(title = "学历层次", align = 2, sort = 71, dictType = "education")
    ...
    @ExcelField(title = "职务类型", align = 2, sort = 75, dictType = "duty")
    ...
    // @ExcelField(title = "校外教工", align = 2, sort = 63, dictType = "yes_no")
    ...
    @ExcelField(title = "组织机构", align = 2, sort = 26)
    ...
    @Length(min = 1, max = 100, message = "教工号长度必须介于 1 和 100 之间")
    @ExcelField(title = "教工号", align = 2, sort = 45)
    public String getNo() {
        return no;
    }
