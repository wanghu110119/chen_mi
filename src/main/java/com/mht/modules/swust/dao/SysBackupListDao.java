 ...
 */
@MyBatisDao
public interface SysBackupListDao extends CrudDao<SysOrderlist> {
	 ...
	 */
	@Select("select max(cast(order_id as decimal)) from mht_oeg.sys_backupslist")
	...
	void batchInsert(List<SysOrderlist> list);
