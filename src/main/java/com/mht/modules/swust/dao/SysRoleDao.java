 ...
 */
@MyBatisDao
public interface SysRoleDao extends TreeDao<Role> {
     ...
     * @author com.mhout.sx
     */
    @Select("select id,name,enname,parent_ids parentIds,parent_id \"parent.id\" from mht_oeg.sys_role where del_flag='0'")
    ...
    @Select("select id,name,enname,parent_ids parentIds,parent_id \"parent.id\",ur.user_id otherId "
            + "from mht_oeg.sys_role r left join mht_oeg.sys_user_role ur on r.id=ur.role_id and ur.user_id=#{0} where r.del_flag='0'")
     ...
     * @author com.mhout.sx
     */
    @Delete("delete from mht_oeg.sys_user_role where user_id=#{0}")
     ...
     * @author com.mhout.sx
     */
    @Insert("insert into mht_oeg.sys_user_role(user_id,role_id) VALUES(#{0},#{1})")
     ...
     * @author com.mhout.sx
     */
    @Select("select id from mht_oeg.sys_role where enname=#{0} and del_flag='0'")
     ...
     * @author com.mhout.sx
     */
    @Select("select id,name from mht_oeg.sys_role r,mht_oeg.sys_user_role ur where ur.user_id=#{0} and r.id=ur.role_id and r.del_flag='0' and r.enname<>#{1} ")
     ...
     * @author com.mhout.sx
     */
    @Select("select id,name from mht_oeg.sys_role r,mht_oeg.sys_user_role ur where ur.user_id=#{0} and r.id=ur.role_id and r.del_flag='0' ")
