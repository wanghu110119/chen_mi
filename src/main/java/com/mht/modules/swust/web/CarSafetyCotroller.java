...
public class CarSafetyCotroller  extends BaseController{
	@Autowired
        ...
        try {
            ...
            for (SysCar sysCar : list) {
                ...
                try {
                    ...
                    if ("true".equals(checkSysCar(sysCar))) {
...
//		}
	...
	private String checkSysCar(SysCar sysCar) {
    	if(sysCar.getCarId()==null||"".equals(sysCar.getCarId())||
    			sysCar.getUserName()==null||
...
//		sysCar.setRemarks(carService.insertCarId());
		...
		sysCar.setEffectiveTime(sysCar.getEffectiveTime());
		carService.save(sysCar);
