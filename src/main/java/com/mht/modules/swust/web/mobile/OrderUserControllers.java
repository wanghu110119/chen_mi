 ...
 */
@Controller
@RequestMapping(value = "mobile/swust/order")
public class OrderUserControllers extends BaseController{
	...
	public String UserSelectOrderList(String name,String state,String color,SysOrderlist sysOrderlist,HttpServletRequest request, 
		...
		return "modules/swust/mobile/sysOrderlist";
	}
	/**
	 * 
	 * @Description: 查询警告预约
	...
	public String insertOrder(Model model){
		...
		return "modules/swust/mobile/sysOrderAdd";
	}
	 ...
	 */
		...
		public AjaxJson UserSelectPassword(String oldPassword, HttpServletResponse resp,HttpServletRequest req, HttpSession session)
				throws IOException {
			AjaxJson ajax = new AjaxJson();
...
//	        return "modules/sys/accountSafe";
		...
		public String initialization(String state,HttpServletRequest request,HttpServletResponse response,String pageCode,Model model){
			...
			return "/modules/swust/mobile/initializationLogin";
		}
