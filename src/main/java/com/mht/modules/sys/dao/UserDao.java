...
public interface UserDao extends CrudDao<User> {
	 ...
	 * 保存用户的扩展信息
	 * @param id
	 * @param extendInfoJson
	 */
	public void insertExtendInfo(String id, String extendInfoJson);
	
	public User getTypeUser(@Param("list")List<String> list, @Param("value")String value);
	
	public User findUserByNoOrIdNo(User user);
	
	@Select("select id from sys_user where login_name = #{0} and del_flag = '0'")
