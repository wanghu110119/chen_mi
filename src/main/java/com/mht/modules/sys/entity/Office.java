...
public class Office extends TreeEntity<Office> {
    ...
    private String type; // 机构类型（1：行政；2：教学）
    ...
    @ExcelField(title = "单位用户名", align = 2, sort = 5 )
    public String getLoginName() {
    	if(getPrimaryPerson()==null){
    		setPrimaryPerson(new User());
    	}
		return getPrimaryPerson().getLoginName();
	}
    @ExcelField(title = "联系人", align = 2, sort = 10 )
    public String getPersonName() {
		return getPrimaryPerson().getName();
	}
    @ExcelField(title = "联系电话", align = 2, sort = 20 )
    public String getPersonPhone() {
		return getPrimaryPerson().getPhone();
	}
    ...
    public void setLoginName(String name) {
    	...
    	getPrimaryPerson().setLoginName(name);
	}
    public void setPersonName(String name) {
    	getPrimaryPerson().setName(name);
	}
	public void setPersonPhone(String name) {
		getPrimaryPerson().setPhone(name);
	}
	...
	public String toString() {
		return "Office [area=" + area + ", code=" + code + ", name=" + name + ", type=" + type + ", grade=" + grade
				+ ", address=" + address + ", zipCode=" + zipCode + ", master=" + master + ", phone=" + phone + ", fax="
				+ fax + ", email=" + email + ", useable=" + useable + ", primaryPerson=" + primaryPerson
				+ ", deputyPerson=" + deputyPerson + ", childDeptList=" + childDeptList + ", postIds=" + postIds
				+ ", postNames=" + postNames + "]";
	}
